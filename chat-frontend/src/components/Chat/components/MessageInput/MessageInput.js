    ...
    return (
        ...
        <div id='input-container'>
                ...
                <div id='image-upload'>
                    {
                        ...
                        <div id='image-details'>
                            ...
                            <FontAwesomeIcon  icon='upload' onClick={handleImageUpload} className='fa-icon'/>
                            <FontAwesomeIcon onClick ={() => setImage('')} icon='times' className='fa-icon'/>
                        </div>
                        : null
                    }
                    <FontAwesomeIcon  icon={['far' , 'image']} className='fa-icon' onClick={() => fileUpload.current.click()}/>
                </div>
            ...
            <div id='message-input'>
                <input type='text' value={message} ref={msgInput} onChange={e => handleMessage(e)} onKeyDown={e => handleKeyDown(e, false)} placeholder='Enter your text here'/>
                <FontAwesomeIcon onClick={() => setShowEmojiPicker(!showEmojiPicker)} icon={['far', 'smile']} className='fa-icon'/>
            </div>
            <input id='chat-image' ref={fileUpload} type='file' onChange = {e => setImage(e.target.files[0])}/>
            {
                showEmojiPicker
                ? <Picker title='Pick your emoji' emoji='point_up'  onSelect={selectEmoji} style={{position:'absolute', bottom: '20px', right:'20px'}}/>
                : null
            }
        </div>
    )
